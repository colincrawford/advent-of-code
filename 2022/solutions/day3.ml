...
let part2 input =
  let find_badge elf1 elf2 elf3 =
    ...
    if (List.length common_items) <> 1 then raise (InvalidNumberOfCommonItems (List.length common_items))
